...
const laptopScene = () =>
{
    ...
    gltfLoader.load(
        ...
        (gltf) => {
            ...
            iframeGroup.add(new Element('./html/bigger.html', 5.14, 1.4, 1.7, 0, -1.57, -0.17, 0.01, '880px', '730px', 5.71, 4.83, 5.93));
            iframeGroup.add(new Element('./html/big.html', 5.64, 3.01, -7.85, 0, -1.57, -0.17, 0.01, '390px', '335px', 5.87, 4.5, -6.06));
            iframeGroup.add(new Element('./html/small.html', 4.977, -0.82, -7.2, 0, -1.57, -0.17, 0.01, '270px', '190px', 5.09, -0.04, -6.01));
            iframeGroup.add(new Element('./html/smaller.html', 5.72, 4.54, -4.323, 0, -1.57, -0.17, 0.01, '158px', '105px', 0, 0, 0));
            counter = 47;
